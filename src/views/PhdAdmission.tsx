      ...
      <section id="promise" className="smru-section bg-white scroll-mt-40">
         <div className="smru-container">
            <div className="text-center mb-20 space-y-4">
               <h3 className="text-4xl md:text-5xl font-black text-[#0d315c] uppercase tracking-tighter">The St. Mary's University <span className="text-[#ffaf3a]">Edge</span></h3>
        ...
        <section className="smru-section text-center relative overflow-hidden bg-[#019e6e] text-white">
          <div className="smru-container relative z-10 space-y-20">
             ...
             <div className="pt-24 space-y-12">
                <h3 className="text-2xl md:text-3xl font-black text-[#ffaf3a] tracking-[0.5em] uppercase leading-snug">St. Mary's University</h3>
                <TrustBand
                  dark
