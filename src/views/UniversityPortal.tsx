...
const UniversityPortal = () => {
  ...
  return (
    <>
      ...
      {/* Cinematic Transition Loader Overlay (IIAT Branded) */}
        ...
        {!isIframeLoaded && (
          ...
          >
            ...
            >
              ...
              <div className="w-56 h-1 bg-slate-100 cut-corner-underline overflow-hidden relative shadow-inner">
                <motion.div 
                  initial={{ left: "-100%" }}
                  animate={{ left: "100%" }}
                  transition={{ 
      ...
      <div className="university-iframe-wrapper relative bg-white">
        <iframe
          ref={iframeRef}
          id="universityIframe"
