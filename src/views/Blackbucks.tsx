...
const BlackbucksPortal = () => {
  ...
  return (
    <>
      ...
      {/* Cinematic Transition Loader Overlay (Same as NIAT & University) */}
        ...
        {!isIframeLoaded && (
          ...
          >
            ...
            >
              ...
              >
                Connecting to BlackBucks Portal
              </motion.p>
            </motion.div>
          </motion.div>
        )}
      ...
      <div className="blackbucks-iframe-wrapper relative bg-white">
        <iframe
          ref={iframeRef}
          id="blackbucksIframe"
...
export default BlackbucksPortal;
