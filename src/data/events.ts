...
export const UNIVERSITY_EVENTS: UniversityEvent[] = [
  {
    ...
    location: "St. Mary's University, Hyderabad",
    summary:
    ...
    body: [
      "On World Environment Day, St. Mary's University organized a large-scale Tree Plantation Drive under the Plant4Mother initiative launched by the Hon'ble Prime Minister. The campaign was dedicated as a tribute to mothers and aimed at promoting environmental conservation across the nation.",
    ...
    images: [
      {
        ...
        alt: "St. Mary's University Tree Plantation Drive participants watering a newly planted tree",
      },
      {
        src: "/assets/events/tree-plantation-drive-2026/tree-plantation-drive-02.webp",
        alt: "St. Mary's University faculty and students participating in the Tree Plantation Drive",
      },
      {
        src: "/assets/events/tree-plantation-drive-2026/tree-plantation-drive-03.webp",
        alt: "St. Mary's University campus Tree Plantation Drive near the university entrance",
      },
    ],
