export const ABOUT_FAQS = [
  ...
  },
  {
    ...
    answer:
      "The Governing Council supports academic leadership, transparent governance, institutional accountability, and compliance-driven university administration.",
  },
  {
    question: "Where can official university recognition details be verified?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Near Ramoji Film City, Deshmukhi Village, Yadadri Bhuvanagiri District, Hyderabad, Telangana.",
  },
  {
    question: "How can students apply?",
    answer:
      "Students can use the official admissions route or contact the admissions support team for guidance.",
  },
  {
    question: "Is hostel support available?",
    answer:
      "On-campus residential support is available subject to university norms and availability.",
  },
];
