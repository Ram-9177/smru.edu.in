...
const PROFILES: Record<string, HealthAlliedCourseSeoProfile> = {
  "physiotherapy/bpt": profile({
    ...
    directAnswer: "BPT (Bachelor of Physiotherapy) at St. Mary's University (SMRU), Hyderabad trains physiotherapists to assess and treat movement, pain and function across musculoskeletal, neurological, cardiorespiratory and sports conditions, combining classroom science with supervised clinical practice.",
  ...
  "physiotherapy/mpt": profile({
    ...
    directAnswer: "MPT (Master of Physiotherapy) at St. Mary's University (SMRU), Hyderabad is a postgraduate programme that deepens clinical reasoning and specialist physiotherapy practice through advanced assessment, evidence-based treatment and a research component.",
  ...
  "physiotherapy/phd-physiotherapy": profile({
    ...
    directAnswer: "Ph.D. in Physiotherapy at St. Mary's University (SMRU), Hyderabad is a doctoral research programme for physiotherapy graduates who want to contribute original research to rehabilitation science under a supervisor; the current cycle, eligibility and fee are confirmed by the university.",
  ...
  "physiotherapy/phd-physiotherapy-neurology": profile({
    ...
    directAnswer: "Ph.D. in Physiotherapy (Neurology) at St. Mary's University (SMRU), Hyderabad is a doctoral research programme in neuro-rehabilitation — stroke, spinal-cord injury and neurological movement disorders — under a research supervisor; the current cycle, eligibility and fee are confirmed by the university.",
  ...
  "occupational-therapy/bot": profile({
    ...
    directAnswer: "BOT (Bachelor of Occupational Therapy) at St. Mary's University (SMRU), Hyderabad trains occupational therapists to help people with physical, developmental or mental-health conditions regain the skills of daily living, work and play, through assessment, therapeutic activity and assistive technology.",
  ...
  "occupational-therapy/mot": profile({
    ...
    directAnswer: "MOT (Master of Occupational Therapy) at St. Mary's University (SMRU), Hyderabad is a postgraduate programme that advances occupational-therapy practice in specialist areas, assistive technology and rehabilitation leadership, with a research component.",
  ...
  "occupational-therapy/phd-occupational-therapy": profile({
    ...
    directAnswer: "Ph.D. in Occupational Therapy at St. Mary's University (SMRU), Hyderabad is a doctoral research programme for OT graduates pursuing original research in occupational science and rehabilitation under a supervisor; the current cycle, eligibility and fee are confirmed by the university.",
  ...
  "allied-health-sciences/bmlt": profile({
    ...
    directAnswer: "Medical Laboratory Technology at St. Mary's University (SMRU), Hyderabad trains the laboratory professionals who run diagnostic testing — haematology, clinical biochemistry, microbiology and histopathology — through hands-on laboratory practice and clinical postings.",
  ...
  "allied-health-sciences/bsc-anaesthesia-ot": profile({
    ...
    directAnswer: "Anaesthesia & Operation Theatre Technology at St. Mary's University (SMRU), Hyderabad trains technologists who prepare and run the operation theatre and assist anaesthetists — equipment, patient monitoring, sterile technique and safety — through skills labs and supervised theatre postings.",
  ...
  "allied-health-sciences/bcvt": profile({
    ...
    directAnswer: "Cardiovascular Technology at St. Mary's University (SMRU), Hyderabad trains technologists in cardiac diagnostics and catheterisation-laboratory support — ECG, echocardiography, stress testing and cath-lab procedures — with clinical postings in cardiac units.",
  ...
  "allied-health-sciences/betcms": profile({
    ...
    directAnswer: "Emergency Medical Technology at St. Mary's University (SMRU), Hyderabad trains emergency and trauma-care professionals in triage, pre-hospital care, resuscitation and emergency-department support, through simulation and supervised clinical postings.",
  ...
  "allied-health-sciences/b-optometry": profile({
    ...
    directAnswer: "Optometry at St. Mary's University (SMRU), Hyderabad trains primary eye-care professionals to examine vision, detect refractive errors and common eye conditions, prescribe corrective lenses and manage low vision, with clinical practice in eye-care settings.",
  ...
  "allied-health-sciences/brt": profile({
    ...
    directAnswer: "Radiotherapy Technology at St. Mary's University (SMRU), Hyderabad trains technologists who plan and deliver radiation treatment for cancer patients — treatment-planning fundamentals, machine operation and radiation safety — with postings in oncology departments.",
  ...
  "allied-health-sciences/bsc-forensic-science": profile({
    ...
    directAnswer: "B.Sc. Forensic Science at St. Mary's University (SMRU), Hyderabad is a science programme in crime-scene investigation and laboratory analysis — evidence collection, fingerprinting, toxicology, forensic biology and digital forensics — with laboratory practice.",
  ...
  "allied-health-sciences/diploma-anaesthesia-operation-theatre-technology": profile({
    ...
    directAnswer: "The Diploma in Anaesthesia & Operation Theatre Technology at St. Mary's University (SMRU), Hyderabad is a shorter, practice-focused route into operation-theatre and anaesthesia-support roles, covering equipment, sterile technique and patient monitoring.",
  ...
  "allied-health-sciences/bachelor-nutrition-dietetics-hons": profile({
    ...
    directAnswer: "Bachelor of Nutrition and Dietetics (Hons) at St. Mary's University (SMRU), Hyderabad trains dietitians in clinical nutrition, diet planning for medical conditions, community nutrition and food science, with practical and clinical placements.",
  ...
  "allied-health-sciences/diploma-radiotherapy-technology": profile({
    ...
    directAnswer: "The Diploma in Radiotherapy Technology at St. Mary's University (SMRU), Hyderabad is a practice-focused route into radiotherapy treatment-room support, covering machine operation, patient positioning and radiation safety.",
  ...
  "allied-health-sciences/bpa": profile({
    ...
    directAnswer: "Bachelor of Physician Assistant at St. Mary's University (SMRU), Hyderabad trains clinical professionals who work alongside physicians — history-taking, examination, care coordination and procedural assistance — with supervised hospital postings.",
  ...
  "allied-health-sciences/diploma-dialysis-technology": profile({
    ...
    directAnswer: "The Diploma in Dialysis Technology at St. Mary's University (SMRU), Hyderabad is a practice-focused route into dialysis-unit roles, covering haemodialysis machine operation, renal-care workflow and patient monitoring.",
  ...
  "allied-health-sciences/bdtt": profile({
    ...
    directAnswer: "Bachelor of Dialysis Therapy Technology at St. Mary's University (SMRU), Hyderabad trains dialysis technologists in renal care — haemodialysis and peritoneal dialysis, water treatment, vascular access and patient monitoring — with clinical postings in dialysis units.",
  ...
  "allied-health-sciences/brt-respiratory": profile({
    ...
    directAnswer: "Bachelor of Respiratory Technology at St. Mary's University (SMRU), Hyderabad trains respiratory therapists in pulmonary care — ventilator management, oxygen therapy, pulmonary function testing and ICU support — with supervised clinical postings.",
  ...
  "allied-health-sciences/bmit": profile({
    ...
    directAnswer: "B.Sc. Medical Imaging Technology at St. Mary's University (SMRU), Hyderabad trains imaging technologists to operate X-ray, CT, MRI and ultrasound equipment safely, position patients correctly and support radiologists, with postings in imaging departments.",
  ...
  "allied-health-sciences/bsc-him": profile({
    ...
    directAnswer: "B.Sc. Health Information Management at St. Mary's University (SMRU), Hyderabad trains the professionals who manage clinical records and health data — medical coding, health informatics, privacy and healthcare analytics — for hospitals and health systems.",
  ...
  "allied-health-sciences/bsc-public-health": profile({
    ...
    directAnswer: "B.Sc. Public Health at St. Mary's University (SMRU), Hyderabad studies the health of populations — epidemiology, community health, health policy and programme management — preparing graduates for public-health organisations and community programmes.",
