...
| Partner landing copy — edinbox ("India's First Rehabilitation University", "100-bedded hospital", "50+ years / 5,000 graduates"), qtst ("India's pioneering", "world-class"), veloces (hard B.Tech fee figures) | `/partner/edinbox/`, `/partner/qtst/`, `/partner/veloces/` (now noindex) | These are unverified superlatives / fees about SMRU on SMRU's domain; pages are noindexed until the partner corrects the copy, then re-index | Partnerships (ask each partner to align to the bridge sentence; remove fees not on the official site) |
