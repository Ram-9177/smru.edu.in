...
export const metadata = buildRedirectMetadata("/schools/law/", "This older LL.M. Law URL has moved to the current School of Law page.");

export default function Page() {
  return (
    <RedirectFallback
      targetUrl="/schools/law/#programmes"
